...
#Title
st.set_page_config(page_title="Smart Hospital Patient Navigator by Abigail", page_icon="😗", layout="wide")
...
with st.form("triage_form"):
    ...
    with col_temp:
        temperature_level = st.selectbox("Temperature Level", options=list(temp_map.keys()), index=1)
    with col_hr:
...
if submitted:
    patient = pd.DataFrame([{
        ...
        'nausea_vomiting' : int(nausea_vomitting),
